...
<html>
<head>
<title>Launch Page: Labyrinth Lord Cleric Generator</title>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#clericForm").attr('action', "character/ll_cleric_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
